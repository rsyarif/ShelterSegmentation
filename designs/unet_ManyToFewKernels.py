...
# expected input shape
    ...
    conv1 = Conv2D(512, (3, 3), activation='relu', padding='same')(inputs) # -> convolution to  features: 32     window: 3
    conv1 = Conv2D(512, (3, 3), activation='relu', padding='same')(conv1)  # -> convolution to  features: 32     window: 9
    pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)                         # -> maxpool to      features: 32     image : x / ( 2 )

    conv2 = Conv2D(256, (3, 3), activation='relu', padding='same')(pool1)  # -> convolution to  features: 64     window: 18
    conv2 = Conv2D(256, (3, 3), activation='relu', padding='same')(conv2)  # -> convolution to  features: 64     window: 18
    ...
    conv8   = Conv2D(256, (3, 3), activation='relu', padding='same')(concat8)
    conv8   = Conv2D(256, (3, 3), activation='relu', padding='same')(conv8)

    up9 = Conv2DTranspose(512, (2, 2), strides=(2, 2), padding='same')(conv8)
    concat9 = concatenate([up9, conv1], axis=3)
    conv9 = Conv2D(512, (3, 3), activation='relu', padding='same')(concat9)
    conv9 = Conv2D(512, (3, 3), activation='relu', padding='same')(conv9)
